	...
	<article class="tile is-child notification is-primary">
		<div class="content">
			<p class="title">Conditions générales d'utilisation</p>
				<p class="subtitle">ARTICLE 1 : Objet</p>
					<div class="content">
						Les présentes <strong>« conditions générales d'utilisation »</strong> ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site [Nom du site] et leur utilisation par <strong>« l'Utilisateur ».</strong>
						...
						<p class="subtitle">ARTICLE 2 : Mentions légales</p>

						L'édition du site <strong>Don nuts</strong> est assurée par la Société [Nom de la société] [SAS / SA / SARL, etc.] au capital de [montant en euros] € dont le siège social est situé au [adresse du siège social].
						...
						<p class="subtitle">ARTICLE 3 : Définitions</p>
						...
						<p class="subtitle">ARTICLE 4 : accès aux services</p>
						...
						Le site permet à l'Utilisateur un accès gratuit aux services suivants :
						    ...
						    Mise en relation entre les differents utilisateurs ;
						...
						<p class="subtitle">ARTICLE 5 : Propriété intellectuelle</p>
						...
						<p class="subtitle">ARTICLE 6 : Données personnelles</p>
						...
						<p class="subtitle">ARTICLE 7 : Responsabilité et force majeure</p>
						...
						<p class="subtitle">ARTICLE 8 : Liens hypertextes</p>
						...
						<p class="subtitle">ARTICLE 11 : Droit applicable et juridiction compétente</p>
						...
						<p class="subtitle">ARTICLE 12 : Publication par l’Utilisateur</p>
